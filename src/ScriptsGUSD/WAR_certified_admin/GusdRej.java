...
public static void main(String[] args) throws InterruptedException {
	    ...
	    Thread.sleep(4000);
	    WebElement element0= driver.findElement(By.xpath("//h4[text()='Weekly Absence Report Certificated Admin']"));
	    element0.click();
	    WebElement element1= driver.findElement(By.xpath("//a[@class='w-full text-center tableBtn blue radius8']"));
		 ...
		 element20.click();
		 js.executeScript("window.scrollBy(0,500)");
		 WebElement element21 = driver.findElement(By.xpath("//button[@class='custmBtn2 text-[#D92D20] border rounded-lg text-center']")); 
		 element21.click();
